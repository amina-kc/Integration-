...
K_SYSCALL_DECLARE5(K_SYSCALL_ZSOCK_GETSOCKOPT, zsock_getsockopt, int, int, sock, int, level, int, optname, void *, optval, socklen_t *, optlen)

K_SYSCALL_DECLARE5(K_SYSCALL_ZSOCK_SETSOCKOPT, zsock_setsockopt, int, int, sock, int, level, int, optname, const void *, optval, socklen_t, optlen)
